define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example",
        "content": "curl -X POST -d \"DEVICE=fedcba9876543210&phones[0][value]=15555555555&phones[0][name]=Arnold+Schwarzenegger\" https://api.vid.me/video/1234/sms",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "description": "<p>List featured videos. Ordrered by date featured, descending.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "order",
            "description": "<p>null, likes_count,                                   hot_score</p> "
          }
        ],
        "Global Parameters": [
          {
